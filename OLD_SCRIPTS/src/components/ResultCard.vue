  ...
  <div class="result-card">
    ...
    <div class="card-body">
      <div class="metric">
        ...
        <span class="metric-value" :class="{ positive: result.grossGain >= 0, negative: result.grossGain < 0 }">
      ...
      <div class="metric">
        ...
        <span class="metric-value negative">
          -{{ formatCurrency(result.fees.total) }}
        </span>
      </div>
      ...
      <div class="metric highlight">
        ...
        <span class="metric-value" :class="{ positive: result.netGain >= 0, negative: result.netGain < 0 }">
      ...
      <div class="metric">
        ...
        <span class="metric-value" :class="{ positive: result.netReturn >= 0, negative: result.netReturn < 0 }">
      ...
      <div class="metric">
        ...
        <span class="metric-value">
          {{ formatCurrency(result.newCapital) }}
        </span>
      </div>

      <div v-if="result.reinvestment > 0" class="reinvestment-badge">
